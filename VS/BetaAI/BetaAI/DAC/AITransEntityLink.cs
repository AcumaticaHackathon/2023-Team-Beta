...
{
  [Serializable]
  [PXCacheName("AITransEntityLink")]
  public class AITransEntityLink : IBqlTable
  {
    #region TransNbr
    [PXDBString(15, IsUnicode = true, InputMask = "")]
    [PXUIField(DisplayName = "Trans Nbr")]
        [PXDefault(typeof(AITrans.transNbr))]
        //[PXParent(typeof(Select<AITrans, Where<AITrans.transNbr, Equal<AITransEntityLink.transNbr>>>))]
